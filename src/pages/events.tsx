...
export async function getServerSideProps(context: any) {
    ...
    const res1 = await fetch('https://event-hive-26cc.onrender.com/api/events/') // Replace with your API endpoint URL
    const data1 = await res1.json()

    const res2 = await fetch('https://event-hive-26cc.onrender.com/api/tags/') // Replace with your API endpoint URL
